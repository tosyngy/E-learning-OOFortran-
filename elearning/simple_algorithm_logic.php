...
.style2 {font-size: 14mm}
.style4 {font-size: 14px}
-->
</style>
</head>
<body >
 <table align="center"  id="wrapper topbg">
   <tr id="header">
<td height="157"  colspan="2" bordercolor="#FFFFFF" bgcolor="#9999FF" >
<div align="center" class="style1 style2" id="header-text" >
<p>PROGRAMMING IN FORTRAN</p>
<div class="links" align="right">
     ...
     <tr>
         <td width="135" height="820" id="" bgcolor="#9999FF" >
             <ol>
    ...
    Uses of and Application of Array
         </div>
    <div id="body_content">
    <p>    <blockquote >
<blockquote>
...
CONTENTS OF SIMPLE ALGORITHM LOGIC NOT YET AVAILABLE
...
<div class="links" align="center">
    ...
    <div id="link-image">
        <a href="intro_to_programming_tools.php">
<img src="logos/next.jpeg" align="right" height="50" width="100"/>
   </a>
   <a href="uses_and_application_of_array.php" >
